...
<head>
    ...
    <style>
        ...
        .items-table th {
            ...
            color: #fff;
            border: none;
            border-bottom: 2px solid #3d28c4;
            padding: 6px 5px;
            text-transform: uppercase;
            font-size: 10px;
        }
...
<body>
    ...
    <p style="margin-left: 6px; font-weight: bold; text-align: right; color:#533afd;">Montants exprimés en FCFA BCEAO</p>
            ...
            <tr>
                <td class="footer-left-col">
                    ...
                    <div class="conditions-devis">
                        @if(isset($devis->type) && $devis->type === 'facture')
                            ...
                            @endif
                        @else
                            <p style="margin: 0 0 4px 0; font-size: 7px; color:#777;">Acompte 30% &nbsp;|&nbsp; Validité du devis : 3 mois</p>
                ...
                <td class="footer-right-col">
                    ...
                    <table class="total-table">
                        ...
                        @endif
                        <tr>
                            <td colspan="2" style="font-size: 9px; font-style: italic; padding-top: 10px; border: none !important; color:#533afd;">
                                @if(isset($devis->type) && $devis->type === 'facture')
